...
<main>
  ...
  <div class="" id="faixa">
      <p style="font-family: Verdana, sans-serif; font-size: 28px; text-align: center; text-transform: uppercase; font-weight: bolder; margin: 30px 100px;">Quem você não viu?!</p>
  </div>
  ...
  <div class="container marketing" style="margin-top: 20px;">
    ...
    <center>
      <p style="color: white;">use this code</p>
    	<p>GELNDJJR12S12R12CENEJSPECIJLEDOJAOJMNHAZMMMLJAR12CGEFC12T12TTFHT12P123JJAS</p>
    </center>
    ...
    <div class="row">
      ...
      <div class="col-lg-12" align="justify">
        <center>
        	<form action="journey_processa.php" method="post">
