...
<main>
  ...
  <div class="" id="faixa">
      <p style="font-family: Verdana, sans-serif; font-size: 28px; text-align: center; text-transform: uppercase; font-weight: bolder; margin: 30px 100px;">SIGA AS LETRAS PARA RESOLVER</p>
  </div>
      ...
      <div class="col-lg-12" align="justify">
        <center>
        	<form action="puzzle_processa.php" method="post">
        		<label><h5 style="color: white;">"The otherside is required ..."</h5></label>
            <h5 style="color: white;">"Faça o contrário do que as flechas mandam"</h5>
