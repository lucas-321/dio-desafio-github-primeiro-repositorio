...
<main>
  ...
  <div class="" id="faixa">
      <p style="font-family: Verdana, sans-serif; font-size: 28px; text-align: center; text-transform: uppercase; font-weight: bolder; margin: 30px 100px;">O que vai sobrar quando eu tirar ele do ano?</p>
  </div>
  ...
  <div class="container marketing" style="margin-top: 20px;">
    ...
    <center>
    	<img src="img/sexta_feira13.png">
        <!--<h1 style="color: red;">OCUPADO</h1>-->
    </center>
    <hr class="">
    ...
    <div class="row">
      ...
      <div class="col-lg-12" align="justify">
        <center>
        	<form action="forte_processa.php" method="post">
        		<label><h5 style="color: black;">Responda com letras grandes</h5></label>
