...
<main>
  ...
  <div class="" id="faixa">
      <p style="font-family: Verdana, sans-serif; font-size: 28px; text-align: center; text-transform: uppercase; font-weight: bolder; margin: 30px 100px;">PARECE COM O PRIMEIRO!</p>
  </div>
  ...
  <div class="container marketing" style="margin-top: 20px;">
    ...
    <center>
    	<h1 title="o que está diferente?">VBFNPVFPMTF</h1>
    </center>
    <hr class="">
    ...
    <div class="row">
      ...
      <div class="col-lg-12" align="justify">
        <center>
        	<form action="atento_processa.php" method="post">
        		<label><h5 style="color: black;">Tower</h5></label>
