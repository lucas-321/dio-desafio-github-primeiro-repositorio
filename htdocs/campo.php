...
<main>
  ...
  <div class="" id="faixa">
      <p style="font-family: Verdana, sans-serif; font-size: 28px; text-align: center; text-transform: uppercase; font-weight: bolder; margin: 30px 100px;">אתר את אבי בעלה!</p>
  </div>
  ...
  <div class="container marketing" style="margin-top: 20px;">
    ...
    <div class="row">
      ...
      <div class="col-lg-12" align="justify">
        <center>
        	<form action="campo_processa.php" method="post">
        		<label><h5 style="color: white;">Sem pontos ou separação</h5></label>
