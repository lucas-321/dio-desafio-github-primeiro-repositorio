...
<main>
  ...
  <div id="myCarousel" class="carousel slide" data-bs-ride="carousel" style="margin-bottom: 0rem;">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/equipes_rivais.png" style="filter: brightness(48%);">
  ...
  <div class="d-none d-lg-block" id="faixa">
      <p style="font-family: Verdana, sans-serif; font-size: 28px; text-align: center; text-transform: uppercase; font-weight: bolder; margin: 30px 100px;">Façam todo o esforço para conservar a unidade do Espírito pelo vínculo da paz." Efésios 4:3</p>
  </div>
  ...
  <div class="container marketing" style="margin-top: 20px">
    ...
    <div class="row">
      ...
      <div class="col-lg-6" align="justify">
        <center><h3><b>Geração Eleita</b></h3>
          <p><img src="img/geracao_eleita.jpeg" class="d-block w-50" style="height: 350px"><br></p>
        </center>
         
        <p><b>Divisa:</b></p>
        <p style="height: 100px;">Mas vós sois a geração eleita, o sacerdòcio real, a nação santa, o povo adquirido, para que anuncieis as virtudes daquele que vos chamou das trevas para a sua maravilhosa luz; <b>1 Pedro 2:9</b></p>
        <p><b>Grito de Guerra:</b></p>
        <p style="height: 100px;"> Geração eleita, viemos pra ganhar! Jesus está conosco e nada vai nos abalar!</p>
        <p><b>Pontuação</b></p>
        <p>6236</p>
      </div>

      <div class="col-lg-6" align="justify">
        <center><h3><b>Unidos em Cristo</b></h3>
          <p><img src="img/unidos_em_cristo2.jpeg" class="d-block w-50" style="height: 350px"><br></p>
        </center>
         
        <p><b>Divisa:</b></p>
        <p style="height: 100px;"> Oh! quão bom e quão suave é que os irmãos vivam em união. É como o óleo precioso sobre a cabeça, que desce sobre a barba, a barba de Arão, e que desce à orla das suas vestes. Como o orvalho de Hermom, e como o que desce sobre os montes de Sião, porque ali o Senhor ordena a bênção e a vida para sempre. <b> Salmos 133:1-3</b></p>
        <p><b>Grito de Guerra:</b></p>
        <p style="height: 100px;"> Muita força, muita raça e muita determinação. Nosso time quer mostrar até mesmo a união. A comunhão é verdadeira e sempre iremos ter. Unidos em Cristo lutando até vencer!</p>
        <p><b>Pontuação</b></p>
        <p>6595</p>
      </div>
