...
<main>
  ...
  <div class="" id="faixa">
      <p style="font-family: Verdana, sans-serif; font-size: 28px; text-align: center; text-transform: uppercase; font-weight: bolder; margin: 30px 100px;">PARABÉNS!!!! VOCÊ SUPEROU UM GRANDE DESAFIO PRA CHEGAR ATÉ AQUI, BUSCOU RESPOSTAS DE DIVERSAS FORMAS E AUMENTOU SEU CONHECIMENTO NESSE PROCESSO, NÃO DESISTIU DE CONTINUAR CAMINHANDO ATÉ A CONCLUSÃO DESSE DESAFIO. CONTINUE ASSIM NA JORNADA DA VIDA E UM FUTURO BRILHANTE SE REVELARÁ A VOCÊ!!</p>
  </div>
  ...
  <div class="container marketing" style="margin-top: 20px;">
    ...
    <!-- START THE FEATURETTES -->
      ...
      <div class="col-md-4">
        <h2 style="color: yellow;"><b>VOCÊ ACERTOU!!!!</b></h2>
        <p style="color: yellow;">Se você chegou aqui primeiro ganha 1000 pontos!!</p>
        <p style="color: yellow;">Se chegou depois ganhará 500!</p>
      	<p style="font-family: Courier;">
          
        </p>
        
      </div>
      <img src="img/logo_ja.jpeg" style="width: 500px;">
    ...
    <div class="row">
      ...
      <div class="col-lg-12" align="justify">
        <center>
        	<!--<form action="puzzle_processa.php" method="post">
        		<label><h5 style="color: white;"></h5></label>
